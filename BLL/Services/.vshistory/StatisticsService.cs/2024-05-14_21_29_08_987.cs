...
namespace BLL.Services
{
    public class StatisticsService: BaseService
    {
        ...
        public CollectionPointStatistics CreatePointStatistics(int point, DateTime startDate, DateTime endDate)
        {
            List<Operation> operations = dbContext.Operation
                .Where(o => o.CollectionPointID == point && o.Time >= startDate && o.Time <= endDate)
                .ToList();
